import { GameState } from "../services/GameEngine.ts";
import { COLOR, Color, PIECE_TYPE } from "../types/enums.ts";
import { ChessPiece, Direction, Location } from "./ChessPiece.ts";
...
export class PawnChessPiece extends ChessPiece {
  ...
  constructor(color: Color, position: string) {
    super(PIECE_TYPE.PAWN, color, position, directions, isRepeatMovement);
